...
const FooterSection = () => {
  return (
    <footer className="h-[30rem] bg-footer-texture lg:bg-top bg-cover flex justify-center items-center px-3 md:px-10 lg:px-20 2xl:px-56 text-white">
      <div className="flex flex-col md:flex-row gap-3 md:items-start md:text-start text-center items-center justify-between">
        <div className="md:w-1/3">
          <h1 className="text-yellow-wahana text-2xl xl:text-3xl w-full font-bold">
            Wahana Virendra
          </h1>
        ...
        <div>
          <h1 className="font-bold lg:text-2xl xl:text-3xl">Menu</h1>
        ...
        <div>
          <h1 className="font-bold lg:text-2xl xl:text-3xl">Support</h1>
          <div className="mt-5 xl:text-xl">
            <p>Syarat & Ketentuan</p>
          </div>
        </div>
        <div>
          <h1 className="font-bold lg:text-2xl xl:text-3xl">Follow us at</h1>
